...
export const putLanguages = (payload: PutLanguagesPayload): PutLanguagesAction => ({
...
export const removeLanguage = (payload: RemoveLanguagePayload): RemoveLanguageAttemptAction => ({
