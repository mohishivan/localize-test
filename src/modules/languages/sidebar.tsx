...
import { ArrowUp, ArrowDown, Pulse, Person, Book, Camera, CheckMark } from './icons'
	...
	return(
		<Container>
			...
			<Infos>
				...
				<Info highlight><InfoLabel>Team</InfoLabel>26</Info>
				<Info><InfoLabel>Keys</InfoLabel>1848</Info>
				<Info highlight><InfoLabel>QA Issues</InfoLabel>47512</Info>
				<Info><InfoLabel>Unverified</InfoLabel>{ unverified }</Info>
			</Infos>
			<Icons>
				<Icon background="#B7D9D0"><ArrowUp/></Icon>
				<Icon background="#DDBBBA"><ArrowDown/></Icon>
				<Icon background="#CFD6C2"><CheckMark/></Icon>
				<Icon background="#D1D1D1"><Person/></Icon>
				<Icon background="#C0C2DA"><Pulse/></Icon>
				<Icon background="#E6C3A4"><Camera/></Icon>
				<Icon background="#B5D1E3"><Book/></Icon>
			</Icons>
			<Tags>
